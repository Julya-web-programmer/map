...
function myFunction() {
    ...
    if (myModal.style.display === 'none' || myModal.style.display === '') {
        ...
        var activerec = document.getElementById('activerec');
        activerec.style.top = (activerec.offsetTop+ 82*vhInPx)+"px";
    } else {
...
function myFunctionB() {
    ...
    button.classList.remove('active');
    button.style.color = "rgba(31, 43, 106, 0.5)"; // Исходный цвет текста
    button.style.borderColor = "#F0F2FF"; // Исходный цвет обводки
